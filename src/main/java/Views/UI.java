...
public class UI {
    ...
    public int vidaCounter = 0;

    public UI(Janela j) {
        this.j = j;

        try {
            InputStream is = getClass().getResourceAsStream("/Assets/fontSrc/Retro Gaming.ttf");
        ...
        try {
            backgroundCreditImage = ImageIO.read(new File("src/main/java/Assets/UISrc/TelasTitle/novaTelaCreditos.png"));
        } catch (IOException e) {
            e.printStackTrace();    
        }
    ...
    public void drawVidaPlayer(){
        ...
        if(j.player[j.playerIndex].life == j.player[j.playerIndex].maxLife){
            ...
            if(j.player[j.playerIndex].life < j.player[j.playerIndex].maxLife && vidaCounter < 32){
                g2.drawImage(vida_cheia_dano, x, y, j.tileSize, j.tileSize, null);
                vidaCounter++;
            }
            else{
            ...
            if(j.player[j.playerIndex].life < j.player[j.playerIndex].maxLife && vidaCounter < 32){
                g2.drawImage(vida_2_dano, x, y, j.tileSize, j.tileSize, null);
                vidaCounter++;
            } else{
            ...
            if(j.player[j.playerIndex].life < j.player[j.playerIndex].maxLife && vidaCounter < 32){
                g2.drawImage(vida_1_dano, x, y, j.tileSize, j.tileSize, null);
                vidaCounter++;
            } else{
